...
const KeymapEntry SUN_TO_USB_KEYMAP[0x80] = {
  ...
  KeymapEntry("KP./DELETE", KEY_KP_DOT, KEY_DELETE),             //  0x32
  ...
  KeymapEntry("KP7/HOME", KEY_KP_7, 0, KEY_HOME),                //  0x44
  KeymapEntry("KP8/UP_ARROW", KEY_KP_8, 0, KEY_UP_ARROW),        //  0x45
  KeymapEntry("KP9/PAGE_UP", KEY_KP_9, 0, KEY_PAGE_UP),          //  0x46
  ...
  KeymapEntry("KP4/LEFT_ARROW", KEY_KP_4, 0, KEY_LEFT_ARROW),    //  0x5B
  KeymapEntry("KP5", KEY_KP_5),                                  //  0x5C
  KeymapEntry("KP6/RIGHT_ARROW", KEY_KP_6, 0, KEY_RIGHT_ARROW),  //  0x5D
  KeymapEntry("KP0/INSERT", KEY_KP_0, 0, KEY_INSERT),            //  0x5E
  ...
  KeymapEntry("KP1/END", KEY_KP_1, 0, KEY_END),                  //  0x70
  KeymapEntry("KP2/DOWN_ARROW", KEY_KP_2, 0, KEY_DOWN_ARROW),    //  0x71
  KeymapEntry("KP3/PAGE_DOWN", KEY_KP_3, 0, KEY_PAGE_DOWN),      //  0x72
